...
import 'package:ungegat/widgets/show_icon_botton.dart';
...
class _DetailState extends State<Detail> {
                ...
                child: ShowIconButton(
                  ...
                  pressFunch: () {
                    MyDialog(context: context).normalDialog(
                        ...
                        title: 'Source Image',
                        subTitle: 'Please Tab Camare or Garally');
                  },
                ),
              )
            ],
  ...
  Future<void> processUploadImage() async {
    String path = 'https://www.androidthai.in.th/egat/saveFilekhaw.php';
    ...
    await Dio().post(path, data: data).then((value) async {
      String urlImage =
          'https://www.androidthai.in.th/egat/khawimage/$nameFile';

      print('Upload Success urlImage = $urlImage');

      String pathAPI =
          'https://www.androidthai.in.th/egat/editPathStatusWhereIdkhaw.php?isAdd=true&id=${jobModel!.id}&pathImage=$urlImage';
